...
public class SavedSingleActivity extends AppCompatActivity implements OnMapReadyCallback, RoutingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saved_single);
        ...
        historyRideInfoDb = FirebaseDatabase.getInstance().getReference().child("Saved").child(rideId);
        getRideInformation();
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    for (DataSnapshot child:dataSnapshot.getChildren()){
                        if (child.getKey().equals("customer")){ //x
                        ...
                        if (child.getKey().equals("distance")){
                            ...
                            ridePrice = Double.valueOf(distance) * 100;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(map.get("ProfilePhotoPath") != null){
                        Glide.with(getApplication()).load(map.get("ProfilePhotoPath").toString()).into(userImage);
                    }
                }
